...
const Description = () => {
  const [pics, isLoading] = useDescription();
      ...
      {isLoading ? (
        ...
        <div className="description">
          <Container className="descriptionBox">
            ...
            <p>
              Bike Decor is a Professional inventory Platform which is trusted
              by over 75,000 companies all over the world. Here we will provide
            ...
            <p>
              ...
              management system. Set up and integrate your business with
              platform like Alibaba, Amazon, Daraz, eBay, Walmart, Etsy,
              WooCommerce or Shopify account, and start selling your
              merchandise.
            </p>
          </Container>
